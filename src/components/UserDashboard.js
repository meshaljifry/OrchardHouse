            ...
            <div className="forecast-grid">
              {forecast.time.map((date, index) => (
                <div key={index} className="forecast-box">
                  ...
                  <p className="forecast-condition">{forecast.weathercode[index] === 0 ? "Clear" : (forecast.weathercode[index] === 1 || forecast.weathercode[index] === 2) ? "Partly Cloudy" : forecast.weathercode[index] === 3 ? "Cloudy" : (forecast.weathercode[index] === 45 || forecast.weathercode[index] === 48) ? "Foggy" : ((forecast.weathercode[index] >= 61 && forecast.weathercode[index] <= 65) || (forecast.weathercode[index] >= 80 && forecast.weathercode[index] <= 82)) ? "Rainy" : (forecast.weathercode[index] >= 95 && forecast.weathercode[index] <= 99) ? "Storms" : ((forecast.weathercode[index] >= 71 && forecast.weathercode[index] <= 75) || (forecast.weathercode[index] >= 85 || forecast.weathercode[index] <= 86)) ? "Snow" : "Other"}</p>
